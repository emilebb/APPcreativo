...
export default function SettingsLayout({ children }: { children: React.ReactNode }) {
  ...
  return (
    <div className="flex h-full min-h-0">
      {/* Sidebar */}
      <nav
        className="w-52 lg:w-56 flex-shrink-0 border-r border-white/5 bg-[#1c1e22] dark:bg-[#1c1e22] py-5 px-3"
              ...
              <li key={category.id}>
                <button
                  ...
                  className={`
                    ...
                    focus:outline-none focus-visible:ring-2 focus-visible:ring-white/30 focus-visible:ring-offset-2 focus-visible:ring-offset-[#1c1e22]
                    ${isActive
                ...
                >
                  {isActive && (
                    <span
                      className="absolute left-0 top-1 bottom-1 w-0.5 bg-[#3b82f6] rounded-r"
                      aria-hidden
                    />
                  )}
                  <Icon
      ...
      {/* Content Panel */}
      <div className="flex-1 min-w-0 overflow-auto bg-[#16171a] dark:bg-[#16171a] text-[#e5e7eb]">
